...
function joiValidateSignup(validate) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    todoSignupSchema = joi_1.default
                        .object({
                    ...
                    return [4 /*yield*/, todoSignupSchema.validate(validate)];
                case 1:
                    validated = _a.sent();
...
var hrs = process.env.ACCESS_EXPIRES;
var signToken = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, jsonwebtoken_1.default.sign({ args: args }, secret, {
                expiresIn: hrs,
            })];
    });
}); };
