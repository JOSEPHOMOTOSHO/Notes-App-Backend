...
exports.getAllNotes = exports.sortByDesc = void 0;
...
var getAllNotes = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var email, folderId, notes, err_1, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, noteModel_1.default.find({ folderId: folderId, softDelete: false, createdBy: req.user.id }).sort("-updatedAt")];
            case 2:
                notes = _a.sent();
                if (notes.length === 0) {
...
function sortByDesc(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var input, result, updateByLatest;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, noteModel_1.default.find().sort(result)
